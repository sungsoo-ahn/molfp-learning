...
def main():
    ...
    parser.add_argument(
        "--dropout_ratio", type=float, default=0.2, help="dropout ratio (default: 0.2)"
    )
    parser.add_argument(
        "--graph_pooling",
        type=str,
    ...
    parser.add_argument(
        "--output_model_file", type=str, default="", help="filename to output the pre-trained model"
    )
    parser.add_argument(
        "--num_workers", type=int, default=8, help="number of workers for dataset loading"
    )
